...
!function () {
    ...
    window.Framework7 = function (a) {
        ...
        function n() {
            var e, a = o(this), t = a[0].scrollTop, n = a[0].scrollHeight, r = a[0].offsetHeight,
                i = a[0].getAttribute("data-distance"), s = a.find(".virtual-list"),
        ...
        var p = function (e, a) {
            ...
            var v, b, w, C, y, x, T, k, P, S, M, I = !1, O = !1, E = {}, D = [], L = [], B = !0, N = [], z = [];
            if (s.handleTouchStart = function (e) {
                    ...
                    if (I = !1, O = !1, 0 === w) return o([D[0], L[0]]).transform("").css({
                        opacity: "",
                        boxShadow: ""
                    }), void(P && (y.transform("").css({opacity: ""}), x.transform("").css({opacity: ""}), T && T.length > 0 && T.transform(""), k && T.length > 0 && k.transform("")));
                    var a = (new Date).getTime() - C, t = !1;
                    (300 > a && w > 10 || a >= 300 && w > b / 2) && (D.removeClass("page-on-center").addClass("page-on-right"), L.removeClass("page-on-left").addClass("page-on-center"), P && (N.removeClass("navbar-on-center").addClass("navbar-on-right"), z.removeClass("navbar-on-left").addClass("navbar-on-center")), t = !0), o([D[0], L[0]]).transform("").css({
                        opacity: "",
                        boxShadow: ""
                    }).addClass("page-transitioning"), P && (y.css({opacity: ""}).each(function () {
                    ...
                    var n = {activePage: D[0], previousPage: L[0], activeNavbar: N[0], previousNavbar: z[0]};
                    if (t) {
                ...
                var A, H = c.split(m)[1];
                f ? A = c.split(i.params.pushStateRoot + m)[1] : m && c.indexOf(m) >= 0 && c.indexOf(m + "#") < 0 && (A = H);
                var R = i.params.pushStateNoAnimation ? !1 : void 0, V = history.state;
                A ? A.indexOf("#") >= 0 && s.params.domCache && V && V.pageName && "viewIndex" in V ? i.router.load(s, {
                    pageName: V.pageName,
                    animatePages: R,
                    pushState: !1
                }) : A.indexOf("#") >= 0 && s.params.domCache && s.initialPagesUrl.indexOf(A) >= 0 ? i.router.load(s, {
                    pageName: A.replace("#", ""),
                    animatePages: R,
                    pushState: !1
                }) : i.router.load(s, {
                    ...
                    animatePages: R,
                    pushState: !1
                }) : m && 0 === H.indexOf("#") && s.initialPagesUrl.indexOf(H) && i.router.load(s, {
                    pageName: H.replace("#", ""),
                    animatePages: R,
                    pushState: !1
                }))
        ...
        i.addView = function (e, a) {
            ...
            var a = o(".popover.modal-in .view"), t = o(".popup.modal-in .view"), n = o(".panel.active .view"),
                r = o(".views"), i = r.children(".view");
                ...
                a.each(function () {
                    ...
                    if (!e.hasClass("cached")) {
                        var a, t, n = i.rtl ? e.find(".right") : e.find(".left"),
                            r = i.rtl ? e.find(".left") : e.find(".right"), s = e.find(".center"),
                            l = e.find(".subnavbar"), p = 0 === n.length, d = 0 === r.length,
                            c = p ? 0 : n.outerWidth(!0), u = d ? 0 : r.outerWidth(!0), m = s.outerWidth(!0),
                            f = e.styles(),
        ...
        var d = function (e, a) {
            ...
            for (var p = [{base: "A", letters: "AⒶＡÀÁÂẦẤẪẨÃĀĂẰẮẴẲȦǠÄǞẢÅǺǍȀȂẠẬẶḀĄȺⱯ"}, {
                base: "AA",
                letters: "Ꜳ"
            ...
            }], d = {}, c = 0; c < p.length; c++) for (var u = p[c].letters, m = 0; m < u.length; m++) d[u[m]] = p[c].base;
            var f = i.rtl ? "margin-left" : "margin-right", h = !1;
            l.setCancelButtonMargin = function () {
                ...
                function e() {
                    !l.searchList.length && !l.params.customSearch || l.container.hasClass("searchbar-active") || l.overlay.addClass("searchbar-overlay-active"), l.container.addClass("searchbar-active"), l.cancelButton.length > 0 && !l.material && (h || l.setCancelButtonMargin(), l.cancelButton.css(f, "0px")), l.triggerEvent("enableSearch", "onEnable"), l.active = !0
                }

                i.device.ios && !i.params.material ? setTimeout(function () {
                    e()
                }, 400) : e()
            }, l.disable = function () {
                function e() {
                ...
                l.input.val("").trigger("change"), l.container.removeClass("searchbar-active searchbar-not-empty"), l.cancelButton.length > 0 && !l.material && l.cancelButton.css(f, -l.cancelButton[0].offsetWidth + "px"), (l.searchList.length || l.params.customSearch) && l.overlay.removeClass("searchbar-overlay-active"), i.device.ios ? setTimeout(function () {
                    e()
                }, 400) : e()
            }, l.clear = function (e) {
            ...
            return l.search = function (e, a) {
                if (e.trim() !== v) {
                    ...
                    if (l.isVirtualList) {
                        ...
                        if (g.params.searchAll) n = g.params.searchAll(e, g.items) || []; else if (g.params.searchByItem) for (var r = 0; r < g.items.length; r++) g.params.searchByItem(e, r, g.params.items[r]) && n.push(r)
                    } else {
                        var i;
                        i = l.params.removeDiacritics ? t(e.trim().toLowerCase()).split(" ") : e.trim().toLowerCase().split(" "), l.searchList.find("li").removeClass("hidden-by-searchbar").each(function (e, a) {
                            ...
                            var e = o(this), a = l.params.ignore && e.is(l.params.ignore),
        ...
        var c = function (e, a) {
            ...
            return i.params = a, i.container = o(e), 0 !== i.container.length ? (i.textarea = i.params.textarea ? o(i.params.textarea) : i.container.find("textarea"), i.pageContainer = i.container.parents(".page").eq(0), i.pageContent = i.pageContainer.find(".page-content"), i.pageContentPadding = parseInt(i.pageContent.css("padding-bottom")), i.initialBarHeight = i.container[0].offsetHeight, i.initialAreaHeight = i.textarea[0].offsetHeight, i.sizeTextarea = function () {
                ...
                if (t + a > e) {
                    var n = t + a, r = i.initialBarHeight + (n - i.initialAreaHeight),
        ...
        i.triggerPageCallbacks = function (e, a, t) {
            ...
            var l = {
                ...
                navbarInnerContainer: r.f7PageData && r.f7PageData.navbarInnerContainer,
                fromPage: t.fromPage
            }, p = t.oldPage, d = t.newPage;
            if (r.f7PageData = l, "after" === e && (i.pluginHook("pageAfterAnimation", l), i.params.onPageAfterAnimation && i.params.onPageAfterAnimation(i, l), i.triggerPageCallbacks("afterAnimation", l.name, l), o(l.container).trigger("pageAfterAnimation", {page: l})), "before" === e) {
            ...
            temporaryDom: document.createElement("div"), findElement: function (e, a, t, n) {
                ...
                a.pageName;
                if ("string" == typeof s ? r ? i.template7Cache[r] && !a.ignoreCache ? n = l.cache[r] : (n = l.compile(s), l.cache[r] = n) : n = l.compile(s) : u && (n = u), d) t = d; else {
                    if (c) if (c.indexOf(".") >= 0) {
            ...
            a = a || {};
            var n, r, s, l, p, d, c, u, m, f = a.url, h = a.content, g = {content: a.content}, v = a.template,
                b = a.pageName, w = o(e.container), C = o(e.pagesContainer), y = a.animatePages,
                x = "undefined" == typeof f && h || v, T = a.pushState;
            ...
            if (i.params.pushState && !a.reloadPrevious && e.main) {
                ...
                var S = i.params.pushStateRoot || "", M = a.reload ? "replaceState" : "pushState";
                T && (x || b ? x && h ? history[M]({
            ...
            if (e.params.uniqueHistory) {
                var E = e.history, D = f;
                if (e.params.uniqueHistoryIgnoreGetParameters) for (E = [], D = f.split("?")[0], l = 0; l < e.history.length; l++) E.push(e.history[l].split("?")[0]);
            ...
            function r() {
                if (i.router.temporaryDom.innerHTML = "", "string" == typeof g || h && "string" == typeof g) i.router.temporaryDom.innerHTML = v.content; else if ("length" in g && g.length > 1) for (var a = 0; a < g.length; a++) o(i.router.temporaryDom).append(g[a]); else o(i.router.temporaryDom).append(g);
            ...
            function s() {
                ...
                if (e.params.dynamicNavbar && "undefined" == typeof f && (f = c && 0 !== c.length ? !0 : !1), p.addClass("page-on-left").removeClass("cached"), f && (u = k.find(".navbar"), m = k.find(".navbar-inner:not(.cached)"), c.addClass("navbar-on-left").removeClass("cached")), x) {
                    var t, r;
                    if (t = o(S[S.length - 2]), f && (r = o(t[0] && t[0].f7RelatedNavbar || m[m.length - 2])), e.params.domCache && e.initialPages.indexOf(t[0]) >= 0) t.length && t[0] !== p[0] && t.addClass("cached"), f && r.length && r[0] !== c[0] && r.addClass("cached"); else {
                        var s = f && r.length;
            ...
            a = a || {};
            var l, p, d, c, u, m, f, h = a.url, g = a.content, v = {content: a.content}, b = a.template,
                w = a.animatePages, C = a.preloadOnly, y = a.pushState, x = (a.ignoreCache, a.force), T = a.pageName,
                k = o(e.container), P = o(e.pagesContainer), S = P.children(".page:not(.cached)"), M = !0;
            ...
            if (e.params.domCache && o(e.container).find(".page.cached").each(function () {
                ...
                }), !e.params.domCache && r && r.indexOf("#") > -1 && r in e.contentCache && -1 === e.history.indexOf(r) && (e.contentCache[r] = null, delete e.contentCache[r]), i.params.pushState && e.main && i.pushStateClearQueue(), e.params.preloadPreviousPage) if (e.params.domCache && e.history.length > 1) {
        ...
        i.modalStack = [], i.modalStackClearQueue = function () {
            ...
            function n() {
                ...
                if (s) {
                    if (l < f - u.top - c ? (w = "bottom", g = u.top) : l < u.top ? (g = u.top - l + c, w = "top") : (w = "bottom", g = u.top), 0 >= g ? g = 8 : g + l >= f && (g = f - l - 8), v = u.left, v + i >= h - 8 && (v = u.left + d - i - 8), 8 > v && (v = 8), "top" === w && e.addClass("popover-on-top"), "bottom" === w && e.addClass("popover-on-bottom"), a.hasClass("floating-button-to-popover") && !e.hasClass("modal-in")) {
                        ...
                        var C = v + i / 2 - (u.left + d / 2), y = g + l / 2 - (u.top + c / 2);
                ...
                } else l + p < u.top ? g = u.top - l - p : l + p < f - u.top - c ? (w = "bottom", g = u.top + c + p) : (w = "middle", g = c / 2 + u.top - l / 2, b = g, 0 >= g ? g = 5 : g + l >= f && (g = f - l - 5), b -= g), "top" === w || "bottom" === w ? (v = d / 2 + u.left - i / 2, b = v, 5 > v && (v = 5), v + i > h && (v = h - i - 5),
                "top" === w && t.addClass("on-bottom"), "bottom" === w && t.addClass("on-top"), b -= v, n = i / 2 - p + b, n = Math.max(Math.min(n, i - 2 * p - 13), 13), t.css({left: n + "px"})) : "middle" === w && (v = u.left - i - p, t.addClass("on-right"), (5 > v || v + i > h) && (5 > v && (v = u.left + d + p), v + i > h && (v = h - i - 5), t.removeClass("on-right").addClass("on-left")), r = l / 2 - p + b, r = Math.max(Math.min(r, l - 2 * p - 13), 13), t.css({top: r + "px"}));
                e.css({top: g + "px", left: v + "px"})
            }
            ...
            return e = o(e), 0 === e.length ? !1 : (o(".picker-modal.modal-in:not(.modal-out)").length > 0 && !e.hasClass("modal-in") && i.closeModal(".picker-modal.modal-in:not(.modal-out)"), e.show(), i.openModal(e), e[0])
            ...
            if (!0 !== e.data("f7-modal-shown")) {
                ...
                var t = (e.hasClass("popover"), e.hasClass("popup")), n = e.hasClass("login-screen"),
            ...
            if (e = o(e || ".modal-in"), "undefined" == typeof e || 0 !== e.length) {
                var a, t = e.hasClass("modal"), n = e.hasClass("popover"), r = e.hasClass("popup"),
                    s = e.hasClass("login-screen"), l = e.hasClass("picker-modal"), p = e.hasClass("remove-on-close");
                return r ? a = o(".popup-overlay") : l && i.params.material ? a = o(".picker-modal-overlay") : l || (a = o(".modal-overlay")), r ? e.length === o(".popup.modal-in").length && a.removeClass("modal-overlay-visible") : a && a.length > 0 && a.removeClass("modal-overlay-visible"), e.trigger("close"), l && (o("body").removeClass("with-picker-modal"), o("body").addClass("picker-modal-closing")), !n || i.params.material ? (e.removeClass("modal-in").addClass("modal-out").transitionEnd(function (a) {
                    if (e.hasClass("modal-out")) e.trigger("closed"); else if (e.trigger("opened"), n) return;
            ...
            function a() {
                r.transitionEnd(function (e) {
                    o(e.target).is(r) ? (t.hasClass("active") ? t.trigger("opened") : t.trigger("closed"), i.params.material && o(".panel-overlay").css({display: ""}), i.allowPanelOpen = !0) : a()
                })
            }
            ...
            function t(e) {
                ...
                if (a = f ? u === -h ? "reset" : 300 > t && Math.abs(u) >= 0 || t >= 300 && Math.abs(u) <= h / 2 ? "left" === r && u === h ? "reset" : "swap" : "reset" : 0 === u ? "reset" : 300 > t && Math.abs(u) > 0 || t >= 300 && Math.abs(u) >= h / 2 ? "swap" : "reset", "swap" === a && (i.allowPanelOpen = !0, f ? (i.closePanel(), p && (n.css({display: ""}), o("body").removeClass("panel-closing"))) : i.openPanel(r), p && (i.allowPanelOpen = !0)), "reset" === a) if (f) i.allowPanelOpen = !0, i.openPanel(r); else if (i.closePanel(), p) i.allowPanelOpen = !0, n.css({display: ""}); else {
                    ...
                    n.trigger("close"), o("body").addClass("panel-closing"), c.transitionEnd(function () {
                        n.trigger("closed"), n.css({display: ""}), o("body").removeClass("panel-closing"), i.allowPanelOpen = !0
                    })
                }
        ...
        var h = function (e, a) {
            ...
            return r.params = a, r.container = o(e), 0 !== r.container.length ? (r.params.autoLayout && r.container.addClass("messages-auto-layout"), r.params.newMessagesFirst && r.container.addClass("messages-new-first"), r.pageContainer = r.container.parents(".page").eq(0), r.pageContent = r.pageContainer.find(".page-content"), r.template = Template7.compile(r.params.messageTemplate), r.layout = function () {
                r.container.hasClass("messages-auto-layout") || r.container.addClass("messages-auto-layout"), r.container.find(".message").each(function () {
                    ...
                    var e = o(this), a = e.hasClass("message-sent"),
        ...
        i.messages = function (e, a) {
            ...
            if (e = o(e), 0 !== e.length && e.hasClass("swipeout-opened")) {
                ...
                for (var d = 0; d < s.length; d++) "right" === n ? o(s[d]).transform("translate3d(" + -s[d].offsetLeft + "px,0,0)") : o(s[d]).transform("translate3d(" + (l - s[d].offsetWidth - s[d].offsetLeft) + "px,0,0)"), o(s[d]).css({left: "0px"}).removeClass("swipeout-overswipe-active");
            ...
            function t() {
                ...
                if (0 !== a.length) {
                    var t, n = parseInt(a.css("padding-top"), 10), r = parseInt(a.css("padding-bottom"), 10),
                        i = a[0].offsetHeight - n - re.height(), s = a[0].scrollHeight - n - re.height(),
                        o = e.offset().top - n + e[0].offsetHeight;
                    if (o > i) {
                        var l = a.scrollTop() + o - i;
                        l + i > s && (t = l + i - s + r, i === s && (t = re.height()), a.css({"padding-bottom": t + "px"})), a.scrollTop(l, 300)
                    }
                }
            }
            ...
            function s(a) {
                ...
                Y && r(a), a.on("change", 'input[name="' + F + '"]', function () {
                    ...
                    P.trigger("change"), e.find(".item-after").text(s.join(", ")), g && "radio" === q && ("popup" === c ? i.closeModal(ne) : "picker" === c ? i.closeModal(re) : d.router.back())
                })
            }

            function p(e) {
                var a = e.detail.page;
                a.name === ae && s(a.container)
            }
            ...
            if (e = o(e), 0 !== e.length) {
                ...
                if (0 !== d.length) {
                    ...
                    var u, m = e.dataset(), f = m.pageTitle || e.find(".item-title").text(),
                    ...
                    var g = void 0 !== m.backOnSelect ? m.backOnSelect : i.params.smartSelectBackOnSelect,
                        ...
                        w = m.toolbarTheme || i.params.smartSelectToolbarTheme, C = m.virtualList,
                        y = m.virtualListHeight, x = i.params.material,
                        T = m.pickerHeight || i.params.smartSelectPickerHeight, k = e.find("select")[0], P = o(k),
                        S = P.dataset();
                    if (!(k.disabled || e.hasClass("disabled") || P.hasClass("disabled"))) {
                        for (var M, I, O, E, D, L, B, N, z, A, H, R = [], V = (new Date).getTime(), q = k.multiple ? "checkbox" : "radio", F = q + "-" + V, Y = P.attr("maxlength"), G = k.name, j = 0; j < k.length; j++) M = o(k[j]), H = M.dataset(), O = H.optionImage || S.optionImage || m.optionImage, E = H.optionIcon || S.optionIcon || m.optionIcon, I = O || E || "checkbox" === q, x && (I = O || E), z = H.optionColor, A = H.optionClass, M[0].disabled && (A += " disabled"), D = M.parent("optgroup")[0], L = D && D.label, B = !1, D && D !== N && (B = !0, N = D, R.push({
                            groupLabel: L,
                            isLabel: B
                        })), R.push({
                            value: M[0].value,
                        ...
                        var W = i._compiledTemplates.smartSelectItem, X = "";
                        if (!C) for (var _ = 0; _ < R.length; _++) X += W(R[_]);
                        var U, J, Q = "", K = "", Z = "";
                        ...
                        }), "page" === c ? (J = "static", e.parents(".navbar-through").length > 0 && (J = "through"), e.parents(".navbar-fixed").length > 0 && (J = "fixed"), Z = e.parents(".page").hasClass("no-toolbar") ? "no-toolbar" : "", K = e.parents(".page").hasClass("no-navbar") ? "no-navbar" : "navbar-" + J) : J = "fixed");
                        var $, ee, ae = "smart-select-" + F,
                            te = "undefined" == typeof e.data("searchbar") ? i.params.smartSelectSearchbar : "true" === e.data("searchbar") ? !0 : !1;
                        te && ($ = e.data("searchbar-placeholder") || "Search", ee = e.data("searchbar-cancel") || "Cancel");
                        var ne, re,
                            ie = '<form class="searchbar searchbar-init" data-search-list=".smart-select-list-' + V + '" data-search-in=".item-title"><div class="searchbar-input"><input type="search" placeholder="' + $ + '"><a href="#" class="searchbar-clear"></a></div>' + (x ? "" : '<a href="#" class="searchbar-cancel">' + ee + "</a>") + '</form><div class="searchbar-overlay"></div>',
                            se = ("picker" !== c && "through" === J ? U : "") + '<div class="pages">  <div data-page="' + ae + '" data-select-name="' + G + '" class="page smart-select-page ' + K + " " + Z + '">' + ("picker" !== c && "fixed" === J ? U : "") + (te ? ie : "") + '    <div class="page-content">' + ("picker" !== c && "static" === J ? U : "") + '      <div class="list-block ' + (C ? "virtual-list" : "") + " smart-select-list-" + V + " " + (v ? "theme-" + v : "") + '">        <ul>' + (C ? "" : X) + "        </ul>      </div>    </div>  </div></div>";
                        "popup" === c ? (a ? (ne = o(".popup.smart-select-popup .view"), ne.html(se)) : (ne = i.popup('<div class="popup smart-select-popup smart-select-popup-' + F + '"><div class="view navbar-fixed">' + se + "</div></div>"), ne = o(ne)), i.initPage(ne.find(".page")), s(ne)) : "picker" === c ? (a ? (re = o(".picker-modal.smart-select-picker .view"), re.html(se)) : (re = i.pickerModal('<div class="picker-modal smart-select-picker smart-select-picker-' + F + '"' + (T ? ' style="height:' + T + '"' : "") + ">" + Q + '<div class="picker-modal-inner"><div class="view">' + se + "</div></div></div>"), re = o(re), t(), o("html").on("click", n), re.once("close", function () {
                            e[0].f7SmartSelectPicker = void 0, o("html").off("click", n), e.parents(".page-content").css({paddingBottom: ""})
                        }), e[0].f7SmartSelectPicker = re[0]), i.initPage(re.find(".page")), s(re)) : (o(document).once("pageInit", ".smart-select-page", p), d.router.load({
                            content: se,
                            reload: a ? !0 : void 0
                        }))
                    }
        ...
        i.virtualList = function (e, a) {
            ...
            if (l.hasClass("pull-to-refresh-content") || (l = l.find(".pull-to-refresh-content")), l && 0 !== l.length) {
                var p, d, c, u, m, f, h, g, v, b, w, C, y, x = {}, T = !1, k = !1, P = 0,
                    S = l.hasClass("page") ? l : l.parents(".page"), M = !1;
            ...
            if (0 !== t.length) {
                ...
                if (n || r || s) {
                    ...
                    if (0 !== l.length) {
                        ...
                        u = m = t[0].scrollTop;
                        var v, b, w, C, y, x, T, k = h && r ? c[0].offsetHeight : 0, P = g && s ? p[0].offsetHeight : 0,
                            S = P || k;
            ...
            var t, n;
            e.hasClass("tabbar-scrollable") ? (t = a[0].offsetWidth + "px", n = (i.rtl ? -a[0].offsetLeft : a[0].offsetLeft) + "px") : (t = 1 / e.find(".tab-link").length * 100 + "%", n = 100 * (i.rtl ? -a.index() : a.index()) + "%"), e.find(".tab-link-highlight").css({width: t}).transform("translate3d(" + n + ",0,0)")
            ...
            function h(e, a, t) {
                var n = t[0].getBoundingClientRect(), r = {x: e - n.left, y: a - n.top}, i = n.height, s = n.width,
            ...
            function w() {
                F ? g() : Y && !N ? (clearTimeout(j), h(S, M, Y), setTimeout(g, 0)) : g()
            }

            function C(e) {
                var a = e.changedTouches[0], t = document.createEvent("MouseEvents"), n = "click";
            ...
            function y(r) {
                if (N = !1, z = !1, r.targetTouches.length > 1) return H && n(), !0;
                if (r.touches.length > 1 && H && n(), i.params.tapHold && (A && clearTimeout(A), A = setTimeout(function () {
                        z = !0, r.preventDefault(), o(r.target).trigger("taphold")
                ...
                })), r.timeStamp - B < i.params.fastClicksDelayBetweenClicks && r.preventDefault(), i.params.activeState && (H = e(O), a(H) ? R = setTimeout(t, 80) : t()), i.params.material && i.params.materialRipple && v(O, S, M)
            }
            ...
            function x(e) {
                if (E) {
                    ...
                    a && (E = !1, O = null, N = !0, i.params.tapHold && clearTimeout(A), i.params.activeState && (clearTimeout(R), n()), i.params.material && i.params.materialRipple && b())
                }
            }

            function T(e) {
                if (clearTimeout(R), clearTimeout(A), !E) return !D && V && (!i.device.android || e.cancelable) && e.preventDefault(), !0;
            ...
            function k(e) {
                E = !1, O = null, clearTimeout(R), clearTimeout(A), i.params.activeState && n(), i.params.material && i.params.materialRipple && w()
            }

            function P(e) {
                var a = !1;
                return E ? (O = null, E = !1, !0) : "submit" === e.target.type && 0 === e.detail ? !0 : (O || r(e.target) || (a = !0), V || (a = !0), document.activeElement === O && (a = !0), e.forwardedTouchEvent && (a = !0), e.cancelable || (a = !0), i.params.tapHold && i.params.tapHoldPreventClicks && z && (a = !1), a || (e.stopImmediatePropagation(), e.stopPropagation(), O ? (d(O) || N) && e.preventDefault() : e.preventDefault(), O = null), q = setTimeout(function () {
                    V = !1
                }, i.device.ios || i.device.androidChrome ? 100 : 400), i.params.tapHold && (A = setTimeout(function () {
                    z = !1
            ...
            var S, M, I, O, E, D, L, B, N, z, A, H, R, V, q, F, Y, G, j;
            ...
            return e.find("input, select, textarea").each(function () {
                ...
                if (!(t.indexOf(s) >= 0) && !(n.indexOf(i) >= 0) && i) if ("select" === l && r.prop("multiple")) n.push(i), a[i] = [], e.find('select[name="' + i + '"] option').each(function () {
            ...
            e.find("input, select, textarea").each(function () {
                var r = o(this), i = r.attr("name"), s = r.attr("type"), l = this.nodeName.toLowerCase();
                if (a[i] && !(t.indexOf(s) >= 0) && !(n.indexOf(i) >= 0) && i) if ("select" === l && r.prop("multiple")) n.push(i), e.find('select[name="' + i + '"] option').each(function () {
            ...
            function a(e) {
                var a = o(this), t = a.val(), r = a.attr("type");
                if (!(n.indexOf(r) >= 0)) {
                ...
                if (!a) {
                    ...
                    if (t) {
                        ...
                        if (n || (n = {viewIndex: i.views.indexOf(t), url: t.history[0]}), !(n.viewIndex < 0)) {
                            var r, s = i.views[n.viewIndex], o = n && n.url || void 0, l = n && n.content || void 0,
        ...
        var v = function (e) {
            ...
            var C, y, x, T, k, P, S, M, I, O, E, D, L, B, N, z, A, H = {}, R = {};
            a.onSlideTouchStart = function (e) {
                ...
                if (h && 0 !== h.length && (a.swiper.allowClick = !1, C && f)) {
                    ...
                    if (!(t < a.swiper.width && n < a.swiper.height)) {
                        if (k = Math.min(a.swiper.width / 2 - t / 2, 0), S = -k, P = Math.min(a.swiper.height / 2 - n / 2, 0), M = -P, R.x = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX, R.y = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, !y && !w && (Math.floor(k) === Math.floor(E) && R.x < H.x || Math.floor(S) === Math.floor(E) && R.x > H.x)) return void(C = !1);
                        e.preventDefault(), e.stopPropagation(), y = !0, x = R.x - H.x + E, T = R.y - H.y + D, k > x && (x = k + 1 - Math.pow(k - x + 1, .8)), x > S && (x = S - 1 + Math.pow(x - S + 1, .8)), P > T && (T = P + 1 - Math.pow(P - T + 1, .8)), T > M && (T = M - 1 + Math.pow(T - M + 1, .8)), L || (L = R.x), z || (z = R.y), B || (B = Date.now()), N = (R.x - L) / (Date.now() - B) / 2, A = (R.y - z) / (Date.now() - B) / 2, Math.abs(R.x - L) < 2 && (N = 0), Math.abs(R.y - z) < 2 && (A = 0), L = R.x, z = R.y, B = Date.now(), g.transform("translate3d(" + x + "px, " + T + "px,0)")
                    }
                }
        ...
        var b = function (e) {
            ...
            e = e || {};
            for (var n in t) "undefined" == typeof e[n] && (e[n] = t[n]);
            a.params = e, a.params.opener && (a.opener = o(a.params.opener));
            var r = a.params.view;
            if (!a.params.view && a.opener && a.opener.length) {
                if (r = a.opener.parents("." + i.params.viewClass), 0 === r.length) return;
                r = r[0].f7View
            }
            if (!a.params.input || (a.input = o(a.params.input), 0 !== a.input.length || "dropdown" !== a.params.openIn)) {
                a.value = a.params.value || [], a.id = (new Date).getTime(), a.inputType = a.params.multiple ? "checkbox" : "radio", a.inputName = a.inputType + "-" + a.id;
                var s = i.params.material, p = a.params.backOnSelect;
                if ("dropdown" !== a.params.openIn) {
                    a.itemTemplate = l.compile(a.params.itemTemplate || '<li><label class="label-{{inputType}} item-content"><input type="{{inputType}}" name="{{inputName}}" value="{{value}}" {{#if selected}}checked{{/if}}>{{#if material}}<div class="item-media"><i class="icon icon-form-{{inputType}}"></i></div><div class="item-inner"><div class="item-title">{{text}}</div></div>{{else}}{{#if checkbox}}<div class="item-media"><i class="icon icon-form-checkbox"></i></div>{{/if}}<div class="item-inner"><div class="item-title">{{text}}</div></div>{{/if}}</label></li>');
                    var d = a.params.pageTitle || "";
                    !d && a.opener && a.opener.length && (d = a.opener.find(".item-title").text());
                    var c, u, m = "autocomplete-" + a.inputName, f = a.params.navbarTheme, h = a.params.formTheme,
                        g = "", v = "";
                    a.navbarTemplate = l.compile(a.params.navbarTemplate || '<div class="navbar {{#if navbarTheme}}theme-{{navbarTheme}}{{/if}}"><div class="navbar-inner"><div class="left sliding">{{#if material}}<a href="#" class="link {{#if inPopup}}close-popup{{else}}back{{/if}} icon-only"><i class="icon icon-back"></i></a>{{else}}<a href="#" class="link {{#if inPopup}}close-popup{{else}}back{{/if}}"><i class="icon icon-back"></i>{{#if inPopup}}<span>{{popupCloseText}}</span>{{else}}<span>{{backText}}</span>{{/if}}</a>{{/if}}</div><div class="center sliding">{{pageTitle}}</div>{{#if preloader}}<div class="right"><div class="autocomplete-preloader preloader {{#if preloaderColor}}preloader-{{preloaderColor}}{{/if}}"></div></div>{{/if}}</div></div>'), c = a.navbarTemplate({
                        pageTitle: d,
                        backText: a.params.backText,
                        popupCloseText: a.params.popupCloseText,
                        openIn: a.params.openIn,
                        navbarTheme: f,
                        inPopup: "popup" === a.params.openIn,
                        inPage: "page" === a.params.openIn,
                        material: s,
                        preloader: a.params.preloader,
                        preloaderColor: a.params.preloaderColor
                    }), "page" === a.params.openIn ? (u = "static", a.opener ? (a.opener.parents(".navbar-through").length > 0 && (u = "through"), a.opener.parents(".navbar-fixed").length > 0 && (u = "fixed"), v = a.opener.parents(".page").hasClass("no-toolbar") ? "no-toolbar" : "", g = a.opener.parents(".page").hasClass("no-navbar") ? "no-navbar" : "navbar-" + u) : r.container && ((o(r.container).hasClass("navbar-through") || o(r.container).find(".navbar-through").length > 0) && (u = "through"), (o(r.container).hasClass("navbar-fixed") || o(r.container).find(".navbar-fixed").length > 0) && (u = "fixed"), v = o(r.activePage.container).hasClass("no-toolbar") ? "no-toolbar" : "", g = o(r.activePage.container).hasClass("no-navbar") ? "no-navbar" : "navbar-" + u)) : u = "fixed";
                    var b = '<form class="searchbar"><div class="searchbar-input"><input type="search" placeholder="' + a.params.searchbarPlaceholderText + '"><a href="#" class="searchbar-clear"></a></div>' + (s ? "" : '<a href="#" class="searchbar-cancel">' + a.params.searchbarCancelText + "</a>") + '</form><div class="searchbar-overlay"></div>',
                        w = ("through" === u ? c : "") + '<div class="pages"><div data-page="' + m + '" class="page autocomplete-page ' + g + " " + v + '">' + ("fixed" === u ? c : "") + b + '<div class="page-content">' + ("static" === u ? c : "") + '<div class="list-block autocomplete-found autocomplete-list-' + a.id + " " + (h ? "theme-" + h : "") + '"><ul></ul></div><div class="list-block autocomplete-not-found"><ul><li class="item-content"><div class="item-inner"><div class="item-title">' + a.params.notFoundText + '</div></div></li></ul></div><div class="list-block autocomplete-values"><ul></ul></div></div></div></div>'
                } else a.dropdownItemTemplate = l.compile(a.params.dropdownItemTemplate || '<li><label class="{{#unless placeholder}}label-radio{{/unless}} item-content" data-value="{{value}}"><div class="item-inner"><div class="item-title">{{text}}</div></div></label></li>'), a.dropdownPlaceholderTemplate = l.compile(a.params.dropdownPlaceholderTemplate || '<li class="autocomplete-dropdown-placeholder"><div class="item-content"><div class="item-inner"><div class="item-title">{{text}}</div></div></label></li>'), a.dropdownTemplate = l.compile(a.params.dropdownTemplate || '<div class="autocomplete-dropdown"><div class="autocomplete-dropdown-inner"><div class="list-block"><ul></ul></div></div>{{#if preloader}}<div class="autocomplete-preloader preloader {{#if preloaderColor}}preloader-{{preloaderColor}}{{/if}}">{{#if material}}{{materialPreloaderHtml}}{{/if}}</div>{{/if}}</div>');
                return a.popup = void 0, a.dropdown = void 0, a.handleInputValue = function (e) {
                    var t = a.input.val();
                    a.params.source && a.params.source(a, t, function (e) {
                        var n = "", r = a.params.limit ? Math.min(a.params.limit, e.length) : e.length;
                        a.items = e;
                        var i, s = new RegExp("(" + t + ")", "i");
                        for (i = 0; r > i; i++) {
                            var o = "object" == typeof e[i] ? e[i][a.params.valueProperty] : e[i];
                            n += a.dropdownItemTemplate({
                                value: o,
                                text: ("object" != typeof e[i] ? e[i] : e[i][a.params.textProperty]).replace(s, "<b>$1</b>")
                            })
                        }
                        "" === n && "" === t && a.params.dropdownPlaceholderText && (n += a.dropdownPlaceholderTemplate({text: a.params.dropdownPlaceholderText})), a.dropdown.find("ul").html(n)
                    })
                }, a.handleDropdownClick = function (e) {
                    for (var t, n = o(this), r = 0; r < a.items.length; r++) {
                        var i = "object" == typeof a.items[r] ? a.items[r][a.params.valueProperty] : a.items[r],
                            s = n.attr("data-value");
                        (i === s || 1 * i === 1 * s) && (t = a.items[r])
                    }
                    a.params.updateInputValueOnSelect && (a.input.val("object" == typeof t ? t[a.params.textProperty] : t), a.input.trigger("input change")), a.params.onChange && a.params.onChange(a, t), a.close()
                }, a.positionDropDown = function () {
                    var e = a.input.parents(".list-block"), t = a.input.parents(".page-content"),
                        n = (parseInt(t.css("padding-top"), 10), parseInt(t.css("padding-top"), 10)),
                        r = a.input.offset(), i = e.length > 0 ? e.offset() : 0,
                        o = t[0].scrollHeight - n - (r.top + t[0].scrollTop) - a.input[0].offsetHeight;
                    a.dropdown.css({
                        left: (e.length > 0 ? i.left : r.left) + "px",
                        top: r.top + t[0].scrollTop + a.input[0].offsetHeight + "px",
                        width: (e.length > 0 ? e[0].offsetWidth : a.input[0].offsetWidth) + "px"
                    }), a.dropdown.children(".autocomplete-dropdown-inner").css({
                        maxHeight: o + "px",
                        paddingLeft: e.length > 0 && !a.params.expandInput ? r.left - (s ? 16 : 15) + "px" : ""
                    })
                }, a.pageInit = function (e) {
                    function t() {
                        var e, t = "";
                        for (e = 0; e < a.value.length; e++) t += a.itemTemplate({
                            value: "object" == typeof a.value[e] ? a.value[e][a.params.valueProperty] : a.value[e],
                            text: "object" == typeof a.value[e] ? a.value[e][a.params.textProperty] : a.value[e],
                            inputType: a.inputType,
                            id: a.id,
                            inputName: a.inputName + "-checked",
                            checkbox: "checkbox" === a.inputType,
                            material: s,
                            selected: !0
                        });
                        l.find(".autocomplete-values ul").html(t)
                    }

                    var n = e.detail.page;
                    if (n.name === m) {
                        var l = o(n.container);
                        i.searchbar(l.find(".searchbar"), {
                            customSearch: !0, onSearch: function (e, t) {
                                0 === t.query.length ? e.overlay.addClass("searchbar-overlay-active") : e.overlay.removeClass("searchbar-overlay-active");
                                var n, r;
                                a.params.source && a.params.source(a, t.query, function (e) {
                                    var i = "", o = a.params.limit ? Math.min(a.params.limit, e.length) : e.length;
                                    for (a.items = e, n = 0; o > n; n++) {
                                        var p = !1, d = "object" == typeof e[n] ? e[n][a.params.valueProperty] : e[n];
                                        for (r = 0; r < a.value.length; r++) {
                                            var c = "object" == typeof a.value[r] ? a.value[r][a.params.valueProperty] : a.value[r];
                                            (c === d || 1 * c === 1 * d) && (p = !0)
                                        }
                                        i += a.itemTemplate({
                                            value: d,
                                            text: "object" != typeof e[n] ? e[n] : e[n][a.params.textProperty],
                                            inputType: a.inputType,
                                            id: a.id,
                                    ...
                                    l.find(".autocomplete-found ul").html(i), 0 === e.length ? 0 !== t.query.length ? (l.find(".autocomplete-not-found").show(), l.find(".autocomplete-found, .autocomplete-values").hide()) : (l.find(".autocomplete-values").show(), l.find(".autocomplete-found, .autocomplete-not-found").hide()) : (l.find(".autocomplete-found").show(), l.find(".autocomplete-not-found, .autocomplete-values").hide())
                                })
                            }
                        });
                        l.on("change", 'input[type="radio"], input[type="checkbox"]', function () {
                            var e, n, s, l, d = this, c = d.value,
                                u = (o(d).parents("li").find(".item-title").text(), o(d).parents(".autocomplete-values").length > 0);
                            if (u) {
                                if ("checkbox" === a.inputType && !d.checked) {
                                    for (e = 0; e < a.value.length; e++) l = "string" == typeof a.value[e] ? a.value[e] : a.value[e][a.params.valueProperty], (l === c || 1 * l === 1 * c) && a.value.splice(e, 1);
                                    t(), a.params.onChange && a.params.onChange(a, a.value)
                                }
                            } else {
                                for (e = 0; e < a.items.length; e++) s = "string" == typeof a.items[e] ? a.items[e] : a.items[e][a.params.valueProperty], (s === c || 1 * s === 1 * c) && (n = a.items[e]);
                                if ("radio" === a.inputType) a.value = [n]; else if (d.checked) a.value.push(n); else for (e = 0; e < a.value.length; e++) l = "string" == typeof a.value[e] ? a.value[e] : a.value[e][a.params.valueProperty], (l === c || 1 * l === 1 * c) && a.value.splice(e, 1);
                                t(), ("radio" === a.inputType && d.checked || "checkbox" === a.inputType) && a.params.onChange && a.params.onChange(a, a.value), p && "radio" === a.inputType && ("popup" === a.params.openIn ? i.closeModal(a.popup) : r.router.back())
                            }
                        }), t(), a.params.onOpen && a.params.onOpen(a)
                    }
                }, a.showPreloader = function () {
                    "dropdown" === a.params.openIn ? a.dropdown && a.dropdown.find(".autocomplete-preloader").addClass("autocomplete-preloader-visible") : o(".autocomplete-preloader").addClass("autocomplete-preloader-visible")
                }, a.hidePreloader = function () {
                    "dropdown" === a.params.openIn ? a.dropdown && a.dropdown.find(".autocomplete-preloader").removeClass("autocomplete-preloader-visible") : o(".autocomplete-preloader").removeClass("autocomplete-preloader-visible")
                }, a.open = function () {
                    if (!a.opened) if (a.opened = !0, "dropdown" === a.params.openIn) {
                        a.dropdown || (a.dropdown = o(a.dropdownTemplate({
                            preloader: a.params.preloader,
                            preloaderColor: a.params.preloaderColor,
                            material: s,
                            materialPreloaderHtml: i.params.materialPreloaderHtml
                        })), a.dropdown.on("click", "label", a.handleDropdownClick));
                        var e = a.input.parents(".list-block");
                        e.length && a.input.parents(".item-content").length > 0 && a.params.expandInput && a.input.parents(".item-content").addClass("item-content-dropdown-expand"), a.positionDropDown(), a.input.parents(".page-content").append(a.dropdown), a.dropdown.addClass("autocomplete-dropdown-in"), a.input.trigger("input"), o(window).on("resize", a.positionDropDown), a.params.onOpen && a.params.onOpen(a)
                    } else o(document).once("pageInit", ".autocomplete-page", a.pageInit), "popup" === a.params.openIn ? (a.popup = i.popup('<div class="popup autocomplete-popup autocomplete-popup-' + a.inputName + '"><div class="view navbar-fixed">' + w + "</div></div>"),
                        a.popup = o(a.popup), a.popup.once("closed", function () {
                        a.popup = void 0, a.opened = !1, a.params.onClose && a.params.onClose(a)
                    })) : (r.router.load({content: w}), o(document).once("pageBack", ".autocomplete-page", function () {
                        a.opened = !1, a.params.onClose && a.params.onClose(a)
                    }))
                }, a.close = function (e) {
                    if (a.opened) {
                        if ("dropdown" === a.params.openIn) {
                            if (e && "blur" === e.type && a.dropdown.find("label.active-state").length > 0) return;
                            a.dropdown.removeClass("autocomplete-dropdown-in").remove(), a.input.parents(".item-content-dropdown-expand").removeClass("item-content-dropdown-expand"), a.opened = !1, o(window).off("resize", a.positionDropDown), a.params.onClose && a.params.onClose(a)
                        }
                        "popup" === a.params.openIn && a.popup && i.closeModal(a.popup)
                    }
                }, a.initEvents = function (e) {
                    var t = e ? "off" : "on";
                    "dropdown" !== a.params.openIn && a.opener && a.opener[t]("click", a.open), "dropdown" === a.params.openIn && a.input && (a.input[t]("focus", a.open), a.input[t]("input", a.handleInputValue), a.input[t]("blur", a.close)), e && a.dropdown && (a.dropdown = null)
                }, a.init = function () {
                    a.initEvents()
                }, a.destroy = function () {
                    a.initEvents(!0), a = null
                }, a.init(), a
            }
        };
        ...
        var w = function (e) {
            ...
            function r(e) {
                if (e.preventDefault(), !p.opened && (p.open(), p.params.scrollToInput && !a())) {
                    ...
                    var n, r = parseInt(t.css("padding-top"), 10), i = parseInt(t.css("padding-bottom"), 10),
                    ...
                    m.setValue = function (e, a, n) {
                        ...
                        if (p.params.rotateEffect) {
                            ...
                            m.items.each(function () {
                                var e = o(this), t = e.index() * h, n = b - a, r = t - n, i = r / h,
                                    s = Math.ceil(m.height / h / 2) + 1, l = -18 * i;
        ...
        var C = function (e) {
            ...
            function r(e) {
                if (e.preventDefault(), !p.opened && (p.open(), p.params.scrollToInput && !a() && !i.params.material)) {
                    var t = p.input.parents(".page-content");
                    if (0 === t.length) return;
                    var n, r = parseInt(t.css("padding-top"), 10), s = parseInt(t.css("padding-bottom"), 10),
            ...
            return p.animating = !1, p.addValue = function (e) {
                ...
                if (p.container && p.container.length > 0) {
                    ...
                    var r;
                    if (p.params.rangePicker && 2 === p.value.length) for (a = p.value[0]; a <= p.value[1]; a += 864e5) r = new Date(a), p.wrapper.find('.picker-calendar-day[data-date="' + r.getFullYear() + "-" + r.getMonth() + "-" + r.getDate() + '"]').addClass("picker-calendar-day-selected"); else for (a = 0; a < p.value.length; a++) r = new Date(p.value[a]), p.wrapper.find('.picker-calendar-day[data-date="' + r.getFullYear() + "-" + r.getMonth() + "-" + r.getDate() + '"]').addClass("picker-calendar-day-selected")
                }
                ...
                var t, n = !1;
                if (!a) return !1;
                if (o.isArray(a)) for (t = 0; t < a.length; t++) a[t].from || a[t].to ? a[t].from && a[t].to ? e <= new Date(a[t].to).getTime() && e >= new Date(a[t].from).getTime() && (n = !0) : a[t].from ? e >= new Date(a[t].from).getTime() && (n = !0) : a[t].to && e <= new Date(a[t].to).getTime() && (n = !0) : e === new Date(a[t]).getTime() && (n = !0); else a.from || a.to ? a.from && a.to ? e <= new Date(a.to).getTime() && e >= new Date(a.from).getTime() && (n = !0) : a.from ? e >= new Date(a.from).getTime() && (n = !0) : a.to && e <= new Date(a.to).getTime() && (n = !0) : "function" == typeof a && (n = a(new Date(e)));
                return n
                ...
                var r = p.daysInMonth(new Date(e.getFullYear(), e.getMonth()).getTime() - 864e6), i = p.daysInMonth(e),
                    s = new Date(e.getFullYear(), e.getMonth()).getDay();
                0 === s && (s = 7);
                var o, l, d, c, u, m, f = [], h = 6, g = 7, v = "", b = 0 + (p.params.firstDay - 1),
                ...
                if (p.value && p.value.length) for (l = 0; l < p.value.length; l++) f.push(new Date(p.value[l]).setHours(0, 0, 0, 0));
                for (l = 1; h >= l; l++) {
                    var x = "";
                    for (d = 1; g >= d; d++) {
                        var T = d;
                        ...
                        var M = o.getFullYear(), I = o.getMonth();
                ...
                var a = parseInt(p.months.eq(p.months.length - 1).attr("data-month"), 10),
                    t = parseInt(p.months.eq(p.months.length - 1).attr("data-year"), 10), n = new Date(t, a),
                    r = n.getTime(), i = p.animating ? !1 : !0;
                ...
                var a = parseInt(p.months.eq(0).attr("data-month"), 10),
                    t = parseInt(p.months.eq(0).attr("data-year"), 10), n = new Date(t, a + 1, -1), r = n.getTime(),
                    i = p.animating ? !1 : !0;
                ...
                var r = new Date(p.currentYear, p.currentMonth).getTime(), i = n > r ? "next" : "prev",
                ...
                var e, a = "", t = "", n = p.value && p.value.length ? p.value[0] : (new Date).setHours(0, 0, 0, 0),
                    r = p.monthHTML(n, "prev"), i = p.monthHTML(n), s = p.monthHTML(n, "next"),
    ...
    var e = function () {
        ...
        e.prototype = {
            addClass: function (e) {
                ...
                for (var t = e.split(" "), n = 0; n < t.length; n++) for (var r = 0; r < this.length; r++) {
                    var i;
                    try {
                        i = new CustomEvent(t[n], {detail: a, bubbles: !0, cancelable: !0})
                    } catch (s) {
                ...
                if (this.length > 0) {
                    var e = this[0], a = e.getBoundingClientRect(), t = document.body,
                        n = e.clientTop || t.clientTop || 0, r = e.clientLeft || t.clientLeft || 0,
                        i = window.pageYOffset || e.scrollTop, s = window.pageXOffset || e.scrollLeft;
        ...
        return a.ajax = function (e) {
            ...
            var v = null;
            if (("POST" === l || "PUT" === l || "PATCH" === l) && e.data) if (e.processData) {
            ...
            return g.onload = function (a) {
                if (T && clearTimeout(T), g.status >= 200 && g.status < 300 || 0 === g.status) {
                    ...
                    } else n = "text" === g.responseType || "" === g.responseType ? g.responseText : g.response, r("ajaxSuccess", {xhr: g}, "success", n, g.status, g)
            ...
            }, r("ajaxStart", {xhr: g}, "start", g), r(void 0, void 0, "beforeSend", g), g.send(v), e.timeout > 0 && (g.onabort = function () {
                T && clearTimeout(T)
    ...
    window.Dom7 = e, Framework7.prototype.support = function () {
        ...
        var a = {}, t = navigator.userAgent, n = e, r = t.match(/(Android);?[\s\/]+([\d.]+)?/),
            i = t.match(/(iPad).*OS\s([\d_]+)/), s = t.match(/(iPod)(.*OS\s([\d_]+))?/),
        ...
        var r = function (e) {
            ...
            function s(e, s) {
                ...
                for (c = 0; c < l.length; c++) {
                    ...
                    if ("plain" !== u.type) {
                        var m, f;
                        if ("variable" === u.type && (m = r(u.contextName, p), d += "r += c(" + m + ", " + p + ");"), "helper" === u.type) if (u.helperName in o.helpers) f = i(u.contextName, p), d += "r += (Template7.helpers." + u.helperName + ").call(" + p + ", " + (f && f + ", ") + "{hash:" + JSON.stringify(u.hash) + ", data: data || {}, fn: " + a(u, s + 1) + ", inverse: " + t(u, s + 1) + ", root: root});"; else {
                            if (u.contextName.length > 0) throw new Error('Template7: Missing helper: "' + u.helperName + '"');
                            m = r(u.helperName, p), d += "if (" + m + ") {", d += "if (isArray(" + m + ")) {", d += "r += (Template7.helpers.each).call(" + p + ", " + m + ", {hash:" + JSON.stringify(u.hash) + ", data: data || {}, fn: " + a(u, s + 1) + ", inverse: " + t(u, s + 1) + ", root: root});", d += "}else {", d += "r += (Template7.helpers.with).call(" + p + ", " + m + ", {hash:" + JSON.stringify(u.hash) + ", data: data || {}, fn: " + a(u, s + 1) + ", inverse: " + t(u, s + 1) + ", root: root});", d += "}}"
                        }
        ...
        function p(e, t) {
            e = a(e);
            var n, i, s, o = b.rtl ? -1 : 1;
            n = e.attr("data-swiper-parallax") || "0", i = e.attr("data-swiper-parallax-x"), s = e.attr("data-swiper-parallax-y"), i || s ? (i = i || "0", s = s || "0") : r() ? (i = n, s = "0") : (s = n, i = "0"), i = i.indexOf("%") >= 0 ? parseInt(i, 10) * t * o + "%" : i * t * o + "px", s = s.indexOf("%") >= 0 ? parseInt(s, 10) * t + "%" : s * t + "px", e.transform("translate3d(" + i + ", " + s + ",0px)")
        }
        ...
        n = n || {};
        var m = {};
        for (var f in n) if ("object" != typeof n[f] || (n[f].nodeType || n[f] === window || n[f] === document || "undefined" != typeof e && n[f] instanceof e || "undefined" != typeof jQuery && n[f] instanceof jQuery)) m[f] = n[f]; else {
            m[f] = {};
            for (var h in n[f]) m[f][h] = n[f][h]
        }
        for (var g in c) if ("undefined" == typeof n[g]) n[g] = c[g]; else if ("object" == typeof n[g]) for (var v in c[g]) "undefined" == typeof n[g][v] && (n[g][v] = c[g][v]);
        var b = this;
        if (b.params = n, b.originalParams = m, b.classNames = [], "undefined" != typeof a && "undefined" != typeof e && (a = e), ("undefined" != typeof a || (a = "undefined" == typeof e ? window.Dom7 || window.Zepto || window.jQuery : e)) && (b.$ = a, b.currentBreakpoint = void 0, b.getActiveBreakpoint = function () {
            ...
            }, b.params.breakpoints && b.setBreakpoint(), b.container = a(t), 0 !== b.container.length)) {
            ...
            b.container[0].swiper = b, b.container.data("swiper", b), b.classNames.push("swiper-container-" + b.params.direction), b.params.freeMode && b.classNames.push("swiper-container-free-mode"), b.support.flexbox || (b.classNames.push("swiper-container-no-flexbox"), b.params.slidesPerColumn = 1), b.params.autoHeight && b.classNames.push("swiper-container-autoheight"), (b.params.parallax || b.params.watchSlidesVisibility) && (b.params.watchSlidesProgress = !0), ["cube", "coverflow"].indexOf(b.params.effect) >= 0 && (b.support.transforms3d ? (b.params.watchSlidesProgress = !0, b.classNames.push("swiper-container-3d")) : b.params.effect = "slide"), "slide" !== b.params.effect && b.classNames.push("swiper-container-" + b.params.effect), "cube" === b.params.effect && (b.params.resistanceRatio = 0, b.params.slidesPerView = 1, b.params.slidesPerColumn = 1, b.params.slidesPerGroup = 1, b.params.centeredSlides = !1, b.params.spaceBetween = 0, b.params.virtualTranslate = !0, b.params.setWrapperSize = !1), "fade" === b.params.effect && (b.params.slidesPerView = 1, b.params.slidesPerColumn = 1, b.params.slidesPerGroup = 1, b.params.watchSlidesProgress = !0, b.params.spaceBetween = 0, "undefined" == typeof u && (b.params.virtualTranslate = !0)), b.params.grabCursor && b.support.touch && (b.params.grabCursor = !1), b.wrapper = b.container.children("." + b.params.wrapperClass), b.params.pagination && (b.paginationContainer = a(b.params.pagination), b.params.paginationClickable && b.paginationContainer.addClass("swiper-pagination-clickable")), b.rtl = r() && ("rtl" === b.container[0].dir.toLowerCase() || "rtl" === b.container.css("direction")), b.rtl && b.classNames.push("swiper-container-rtl"), b.rtl && (b.wrongRTL = "-webkit-box" === b.wrapper.css("display")), b.params.slidesPerColumn > 1 && b.classNames.push("swiper-container-multirow"), b.device.android && b.classNames.push("swiper-container-android"), b.container.addClass(b.classNames.join(" ")), b.translate = 0, b.progress = 0, b.velocity = 0, b.lockSwipeToNext = function () {
            ...
            }, b.params.grabCursor && (b.container[0].style.cursor = "move", b.container[0].style.cursor = "-webkit-grab", b.container[0].style.cursor = "-moz-grab", b.container[0].style.cursor = "grab"), b.imagesToLoad = [], b.imagesLoaded = 0, b.loadImage = function (e, a, t, n, r) {
                function i() {
                    r && r()
                }
                ...
                return "undefined" != typeof b.autoplayTimeoutId ? !1 : b.params.autoplay ? b.autoplaying ? !1 : (b.autoplaying = !0, b.emit("onAutoplayStart", b), void s()) : !1
                ...
                var e, a = b.params.spaceBetween, t = -b.params.slidesOffsetBefore, n = 0, s = 0;
                ...
                var l, p = b.params.slidesPerColumn, d = o / p,
                ...
                for (e = 0; e < b.slides.length; e++) {
                    ...
                    if (b.params.slidesPerColumn > 1) {
                        var m, f, h;
                        "column" === b.params.slidesPerColumnFill ? (f = Math.floor(e / p), h = e - f * p, (f > c || f === c && h === p - 1) && ++h >= p && (h = 0, f++), m = f + h * o / p, u.css({
                            "-webkit-box-ordinal-group": m,
                            "-moz-box-ordinal-group": m,
                            "-ms-flex-order": m,
                            "-webkit-order": m,
                            order: m
                        })) : (h = Math.floor(e / d), f = e - h * d), u.css({"margin-top": 0 !== h && b.params.spaceBetween && b.params.spaceBetween + "px"}).attr("data-swiper-column", f).attr("data-swiper-row", h)
                    }
                    "none" !== u.css("display") && ("auto" === b.params.slidesPerView ? (l = r() ? u.outerWidth(!0) : u.outerHeight(!0), b.params.roundLengths && (l = i(l))) : (l = (b.size - (b.params.slidesPerView - 1) * a) / b.params.slidesPerView, b.params.roundLengths && (l = i(l)), r() ? b.slides[e].style.width = l + "px" : b.slides[e].style.height = l + "px"), b.slides[e].swiperSlideSize = l, b.slidesSizesGrid.push(l), b.params.centeredSlides ? (t = t + l / 2 + n / 2 + a, 0 === e && (t = t - b.size / 2 - a), Math.abs(t) < .001 && (t = 0), s % b.params.slidesPerGroup === 0 && b.snapGrid.push(t), b.slidesGrid.push(t)) : (s % b.params.slidesPerGroup === 0 && b.snapGrid.push(t), b.slidesGrid.push(t), t = t + l + a), b.virtualSize += l + a, n = l, s++)
                }
                ...
                0 === b.snapGrid.length && (b.snapGrid = [0]), 0 !== b.params.spaceBetween && (r() ? b.rtl ? b.slides.css({marginLeft: a + "px"}) : b.slides.css({marginRight: a + "px"}) : b.slides.css({marginBottom: a + "px"})), b.params.watchSlidesProgress && b.updateSlidesOffset()
            }, b.updateSlidesOffset = function () {
                for (var e = 0; e < b.slides.length; e++) b.slides[e].swiperSlideOffset = r() ? b.slides[e].offsetLeft : b.slides[e].offsetTop
                ...
                if ("undefined" == typeof e && (e = b.translate || 0), 0 !== b.slides.length) {
                    ...
                    for (var t = 0; t < b.slides.length; t++) {
                        var n = b.slides[t],
                            r = (a - n.swiperSlideOffset) / (n.swiperSlideSize + b.params.spaceBetween);
                        if (b.params.watchSlidesVisibility) {
                            var i = -(a - n.swiperSlideOffset), s = i + b.slidesSizesGrid[t],
                ...
                var a = b.maxTranslate() - b.minTranslate(), t = b.isBeginning, n = b.isEnd;
                0 === a ? (b.progress = 0, b.isBeginning = b.isEnd = !0) : (b.progress = (e - b.minTranslate()) / a, b.isBeginning = b.progress <= 0, b.isEnd = b.progress >= 1), b.isBeginning && !t && b.emit("onReachBeginning", b), b.isEnd && !n && b.emit("onReachEnd", b), b.params.watchSlidesProgress && b.updateSlidesProgress(e), b.emit("onProgress", b, b.progress)
            }, b.updateActiveIndex = function () {
                var e, a, t, n = b.rtl ? b.translate : -b.translate;
                for (a = 0; a < b.slidesGrid.length; a++) "undefined" != typeof b.slidesGrid[a + 1] ? n >= b.slidesGrid[a] && n < b.slidesGrid[a + 1] - (b.slidesGrid[a + 1] - b.slidesGrid[a]) / 2 ? e = a : n >= b.slidesGrid[a] && n < b.slidesGrid[a + 1] && (e = a + 1) : n >= b.slidesGrid[a] && (e = a);
            ...
            window.navigator.pointerEnabled ? w = ["pointerdown", "pointermove", "pointerup"] : window.navigator.msPointerEnabled && (w = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), b.touchEvents = {
                start: b.support.touch || !b.params.simulateTouch ? "touchstart" : w[0],
                move: b.support.touch || !b.params.simulateTouch ? "touchmove" : w[1],
                end: b.support.touch || !b.params.simulateTouch ? "touchend" : w[2]
                ...
                var t = o(e, "." + b.params.slideClass), n = !1;
                if (t) for (var r = 0; r < b.slides.length; r++) b.slides[r] === t && (n = !0);
                if (!t || !n) return b.clickedSlide = void 0, void(b.clickedIndex = void 0);
                if (b.clickedSlide = t, b.clickedIndex = a(t).index(), b.params.slideToClickedSlide && void 0 !== b.clickedIndex && b.clickedIndex !== b.activeIndex) {
                    var i, s = b.clickedIndex;
                    if (b.params.loop) {
                        if (b.animating) return;
                        i = a(b.clickedSlide).attr("data-swiper-slide-index"), b.params.centeredSlides ? s < b.loopedSlides - b.params.slidesPerView / 2 || s > b.slides.length - b.loopedSlides + b.params.slidesPerView / 2 ? (b.fixLoop(), s = b.wrapper.children("." + b.params.slideClass + '[data-swiper-slide-index="' + i + '"]:not(.swiper-slide-duplicate)').eq(0).index(), setTimeout(function () {
                            b.slideTo(s)
            ...
            var C, y, x, T, k, P, S, M, I, O, E = "input, select, textarea, button", D = Date.now(), L = [];
            ...
            b.onTouchStart = function (e) {
                if (e.originalEvent && (e = e.originalEvent), B = "touchstart" === e.type, B || !("which" in e) || 3 !== e.which) {
                    ...
                    if (!b.params.swipeHandler || o(e, b.params.swipeHandler)) {
                        ...
                        if (!(b.device.ios && b.params.iOSEdgeSwipeDetection && t <= b.params.iOSEdgeSwipeThreshold)) {
                            if (C = !0, y = !1, x = !0, k = void 0, N = void 0, b.touches.startX = t, b.touches.startY = n, T = Date.now(), b.allowClick = !0, b.updateContainerSize(), b.swipeDirection = void 0, b.params.threshold > 0 && (M = !1), "touchstart" !== e.type) {
                                var r = !0;
                ...
                if (e.originalEvent && (e = e.originalEvent), !(B && "mousemove" === e.type || e.preventedByNestedSwiper)) {
                    ...
                    if (B && document.activeElement && e.target === document.activeElement && a(e.target).is(E)) return y = !0, void(b.allowClick = !1);
                    if (x && b.emit("onTouchMove", b, e), !(e.targetTouches && e.targetTouches.length > 1)) {
                        if (b.touches.currentX = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX, b.touches.currentY = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, "undefined" == typeof k) {
                            var t = 180 * Math.atan2(Math.abs(b.touches.currentY - b.touches.startY), Math.abs(b.touches.currentX - b.touches.startX)) / Math.PI;
                            k = r() ? t > b.params.touchAngle : 90 - t > b.params.touchAngle
                        }
                        if (k && b.emit("onTouchMoveOpposite", b, e), "undefined" == typeof N && b.browser.ieTouch && (b.touches.currentX !== b.touches.startX || b.touches.currentY !== b.touches.startY) && (N = !0), C) {
                            if (k) return void(C = !1);
                            if (N || !b.browser.ieTouch) {
                                b.allowClick = !1, b.emit("onSliderMove", b, e), e.preventDefault(), b.params.touchMoveStopPropagation && !b.params.nested && e.stopPropagation(), y || (n.loop && b.fixLoop(), S = b.getWrapperTranslate(), b.setWrapperTransition(0), b.animating && b.wrapper.trigger("webkitTransitionEnd transitionend oTransitionEnd MSTransitionEnd msTransitionEnd"), b.params.autoplay && b.autoplaying && (b.params.autoplayDisableOnInteraction ? b.stopAutoplay() : b.pauseAutoplay()), O = !1, b.params.grabCursor && (b.container[0].style.cursor = "move", b.container[0].style.cursor = "-webkit-grabbing", b.container[0].style.cursor = "-moz-grabbin", b.container[0].style.cursor = "grabbing")), y = !0;
                                var i = b.touches.diff = r() ? b.touches.currentX - b.touches.startX : b.touches.currentY - b.touches.startY;
                                i *= b.params.touchRatio, b.rtl && (i = -i), b.swipeDirection = i > 0 ? "prev" : "next", P = i + S;
                                var s = !0;
                                if (i > 0 && P > b.minTranslate() ? (s = !1, b.params.resistance && (P = b.minTranslate() - 1 + Math.pow(-b.minTranslate() + S + i, b.params.resistanceRatio))) : 0 > i && P < b.maxTranslate() && (s = !1, b.params.resistance && (P = b.maxTranslate() + 1 - Math.pow(b.maxTranslate() - S - i, b.params.resistanceRatio))), s && (e.preventedByNestedSwiper = !0), !b.params.allowSwipeToNext && "next" === b.swipeDirection && S > P && (P = S), !b.params.allowSwipeToPrev && "prev" === b.swipeDirection && P > S && (P = S), b.params.followFinger) {
                                    if (b.params.threshold > 0) {
                                        if (!(Math.abs(i) > b.params.threshold || M)) return void(P = S);
                                        if (!M) return M = !0, b.touches.startX = b.touches.currentX, b.touches.startY = b.touches.currentY, P = S, void(b.touches.diff = r() ? b.touches.currentX - b.touches.startX : b.touches.currentY - b.touches.startY)
                                    }
                                    (b.params.freeMode || b.params.watchSlidesProgress) && b.updateActiveIndex(), b.params.freeMode && (0 === L.length && L.push({
                                        position: b.touches[r() ? "startX" : "startY"],
                                        time: T
                                    }), L.push({
                                        position: b.touches[r() ? "currentX" : "currentY"],
                ...
                if (e.originalEvent && (e = e.originalEvent), x && b.emit("onTouchEnd", b, e), x = !1, C) {
                    b.params.grabCursor && y && C && (b.container[0].style.cursor = "move", b.container[0].style.cursor = "-webkit-grab", b.container[0].style.cursor = "-moz-grab", b.container[0].style.cursor = "grab");
                    var t = Date.now(), n = t - T;
                    if (b.allowClick && (b.updateClickedSlide(e), b.emit("onTap", b, e), 300 > n && t - D > 300 && (I && clearTimeout(I), I = setTimeout(function () {
                            b && (b.params.paginationHide && b.paginationContainer.length > 0 && !a(e.target).hasClass(b.params.bulletClass) && b.paginationContainer.toggleClass(b.params.paginationHiddenClass), b.emit("onClick", b, e))
                        }, 300)), 300 > n && 300 > t - D && (I && clearTimeout(I), b.emit("onDoubleTap", b, e))), D = Date.now(), setTimeout(function () {
                            b && (b.allowClick = !0)
                        }, 0), !C || !y || !b.swipeDirection || 0 === b.touches.diff || P === S) return void(C = y = !1);
                    C = y = !1;
                    var r;
                    if (r = b.params.followFinger ? b.rtl ? b.translate : -b.translate : -P, b.params.freeMode) {
                        ...
                        if (b.params.freeModeMomentum) {
                            if (L.length > 1) {
                                var i = L.pop(), s = L.pop(), o = i.position - s.position, l = i.time - s.time;
                            ...
                            L.length = 0;
                            var p = 1e3 * b.params.freeModeMomentumRatio, d = b.velocity * p, c = b.translate + d;
                            b.rtl && (c = -c);
                            var u, m = !1, f = 20 * Math.abs(b.velocity) * b.params.freeModeMomentumBounceRatio;
                            if (c < b.maxTranslate()) b.params.freeModeMomentumBounce ? (c + b.maxTranslate() < -f && (c = b.maxTranslate() - f), u = b.maxTranslate(), m = !0, O = !0) : c = b.maxTranslate(); else if (c > b.minTranslate()) b.params.freeModeMomentumBounce ? (c - b.minTranslate() > f && (c = b.minTranslate() + f), u = b.minTranslate(), m = !0, O = !0) : c = b.minTranslate(); else if (b.params.freeModeSticky) {
                                var h, g = 0;
                            ...
                            if (0 !== b.velocity) p = b.rtl ? Math.abs((-c - b.translate) / b.velocity) : Math.abs((c - b.translate) / b.velocity); else if (b.params.freeModeSticky) return void b.slideReset();
                            b.params.freeModeMomentumBounce && m ? (b.updateProgress(u), b.setWrapperTransition(p), b.setWrapperTranslate(c), b.onTransitionStart(), b.animating = !0, b.wrapper.transitionEnd(function () {
                                b && O && (b.emit("onMomentumBounce", b), b.setWrapperTransition(b.params.speed), b.setWrapperTranslate(u), b.wrapper.transitionEnd(function () {
                                    b && b.onTransitionEnd()
                                }))
                    ...
                    var v, w = 0, k = b.slidesSizesGrid[0];
                    for (v = 0; v < b.slidesGrid.length; v += b.params.slidesPerGroup) "undefined" != typeof b.slidesGrid[v + b.params.slidesPerGroup] ? r >= b.slidesGrid[v] && r < b.slidesGrid[v + b.params.slidesPerGroup] && (w = v, k = b.slidesGrid[v + b.params.slidesPerGroup] - b.slidesGrid[v]) : r >= b.slidesGrid[v] && (w = v, k = b.slidesGrid[b.slidesGrid.length - 1] - b.slidesGrid[b.slidesGrid.length - 2]);
                    var M = (r - b.slidesGrid[w]) / k;
                    if (n > b.params.longSwipesMs) {
                        if (!b.params.longSwipes) return void b.slideTo(b.activeIndex);
                        "next" === b.swipeDirection && (M >= b.params.longSwipesRatio ? b.slideTo(w + b.params.slidesPerGroup) : b.slideTo(w)), "prev" === b.swipeDirection && (M > 1 - b.params.longSwipesRatio ? b.slideTo(w + b.params.slidesPerGroup) : b.slideTo(w))
                    } else {
            ...
            }, b.slideTo = function (e, a, t, n) {
                "undefined" == typeof t && (t = !0), "undefined" == typeof e && (e = 0), 0 > e && (e = 0), b.snapIndex = Math.floor(e / b.params.slidesPerGroup), b.snapIndex >= b.snapGrid.length && (b.snapIndex = b.snapGrid.length - 1);
                var r = -b.snapGrid[b.snapIndex];
                b.params.autoplay && b.autoplaying && (n || !b.params.autoplayDisableOnInteraction ? b.pauseAutoplay(a) : b.stopAutoplay()), b.updateProgress(r);
                for (var i = 0; i < b.slidesGrid.length; i++) -Math.floor(100 * r) >= Math.floor(100 * b.slidesGrid[i]) && (e = i);
                return !b.params.allowSwipeToNext && r < b.translate && r < b.minTranslate() ? !1 : !b.params.allowSwipeToPrev && r > b.translate && r > b.maxTranslate() && (b.activeIndex || 0) !== e ? !1 : ("undefined" == typeof a && (a = b.params.speed),
                ...
                var n = 0, s = 0, o = 0;
                r() ? n = b.rtl ? -e : e : s = e, b.params.roundLengths && (n = i(n), s = i(s)), b.params.virtualTranslate || (b.support.transforms3d ? b.wrapper.transform("translate3d(" + n + "px, " + s + "px, " + o + "px)") : b.wrapper.transform("translate(" + n + "px, " + s + "px)")), b.translate = r() ? n : s;
                ...
                var t, n, r, i;
                return "undefined" == typeof a && (a = "x"), b.params.virtualTranslate ? b.rtl ? -b.translate : b.translate : (r = window.getComputedStyle(e, null), window.WebKitCSSMatrix ? (n = r.transform || r.webkitTransform, n.split(",").length > 6 && (n = n.split(", ").map(function (e) {
                    return e.replace(",", ".")
                }).join(", ")), i = new window.WebKitCSSMatrix("none" === n ? "" : n)) : (i = r.MozTransform || r.OTransform || r.MsTransform || r.msTransform || r.transform || r.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,"), t = i.toString().split(",")), "x" === a && (n = window.WebKitCSSMatrix ? i.m41 : 16 === t.length ? parseFloat(t[12]) : parseFloat(t[4])), "y" === a && (n = window.WebKitCSSMatrix ? i.m42 : 16 === t.length ? parseFloat(t[13]) : parseFloat(t[5])), b.rtl && n && (n = -n), n || 0)
            }, b.getWrapperTranslate = function (e) {
                return "undefined" == typeof e && (e = r() ? "x" : "y"), b.getTranslate(b.wrapper[0], e)
                ...
                for (e.each(function (t, i) {
                    var s = a(this);
                    t < b.loopedSlides && r.push(i), t < e.length && t >= e.length - b.loopedSlides && n.push(i), s.attr("data-swiper-slide-index", t)
                }), t = 0; t < r.length; t++) b.wrapper.append(a(r[t].cloneNode(!0)).addClass(b.params.slideDuplicateClass));
                for (t = n.length - 1; t >= 0; t--) b.wrapper.prepend(a(n[t].cloneNode(!0)).addClass(b.params.slideDuplicateClass))
                ...
                if ("object" == typeof e && e.length) {
                    for (var n = 0; n < e.length; n++) a = e[n], b.slides[a] && b.slides.eq(a).remove(), t > a && t--;
                    t = Math.max(t, 0)
                ...
                fade: {
                    setTranslate: function () {
                        for (var e = 0; e < b.slides.length; e++) {
                            var a = b.slides.eq(e), t = a[0].swiperSlideOffset, n = -t;
                    ...
                    setTranslate: function () {
                        var e, t = 0;
                        b.params.cube.shadow && (r() ? (e = b.wrapper.find(".swiper-cube-shadow"), 0 === e.length && (e = a('<div class="swiper-cube-shadow"></div>'), b.wrapper.append(e)), e.css({height: b.width + "px"})) : (e = b.container.find(".swiper-cube-shadow"), 0 === e.length && (e = a('<div class="swiper-cube-shadow"></div>'), b.container.append(e))));
                        for (var n = 0; n < b.slides.length; n++) {
                            var i = b.slides.eq(n), s = 90 * n, o = Math.floor(s / 360);
                            b.rtl && (s = -s, o = Math.floor(-s / 360));
                            var l = Math.max(Math.min(i[0].progress, 1), -1), p = 0, d = 0, c = 0;
                            n % 4 === 0 ? (p = 4 * -o * b.size, c = 0) : (n - 1) % 4 === 0 ? (p = 0, c = 4 * -o * b.size) : (n - 2) % 4 === 0 ? (p = b.size + 4 * o * b.size, c = b.size) : (n - 3) % 4 === 0 && (p = -b.size, c = 3 * b.size + 4 * b.size * o), b.rtl && (p = -p), r() || (d = p, p = 0);
                            var u = "rotateX(" + (r() ? 0 : -s) + "deg) rotateY(" + (r() ? s : 0) + "deg) translate3d(" + p + "px, " + d + "px, " + c + "px)";
                            if (1 >= l && l > -1 && (t = 90 * n + 90 * l, b.rtl && (t = 90 * -n - 90 * l)), i.transform(u), b.params.cube.slideShadows) {
                        ...
                        if (b.wrapper.css({
                            ...
                            }), b.params.cube.shadow) if (r()) e.transform("translate3d(0px, " + (b.width / 2 + b.params.cube.shadowOffset) + "px, " + -b.width / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + b.params.cube.shadowScale + ")"); else {
                            var h = Math.abs(t) - 90 * Math.floor(Math.abs(t) / 90),
                                g = 1.5 - (Math.sin(2 * h * Math.PI / 360) / 2 + Math.cos(2 * h * Math.PI / 360) / 2),
                                v = b.params.cube.shadowScale, w = b.params.cube.shadowScale / g,
                                C = b.params.cube.shadowOffset;
                            e.transform("scale3d(" + v + ", 1, " + w + ") translate3d(0px, " + (b.height / 2 + C) + "px, " + -b.height / 2 / w + "px) rotateX(-90deg)")
                        }
                        var y = b.isSafari || b.isUiWebView ? -b.size / 2 : 0;
                        b.wrapper.transform("translate3d(0px,0," + y + "px) rotateX(" + (r() ? 0 : t) + "deg) rotateY(" + (r() ? -t : 0) + "deg)")
                    }, setTransition: function (e) {
                        b.slides.transition(e).find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").transition(e), b.params.cube.shadow && !r() && b.container.find(".swiper-cube-shadow").transition(e)
                    }
                }, coverflow: {
                    setTranslate: function () {
                        for (var e = b.translate, t = r() ? -e + b.width / 2 : -e + b.height / 2, n = r() ? b.params.coverflow.rotate : -b.params.coverflow.rotate, i = b.params.coverflow.depth, s = 0, o = b.slides.length; o > s; s++) {
                            var l = b.slides.eq(s), p = b.slidesSizesGrid[s], d = l[0].swiperSlideOffset,
                                c = (t - d - p / 2) / p * b.params.coverflow.modifier, u = r() ? n * c : 0,
                                m = r() ? 0 : n * c, f = -i * Math.abs(c), h = r() ? 0 : b.params.coverflow.stretch * c,
                                g = r() ? b.params.coverflow.stretch * c : 0;
                            Math.abs(g) < .001 && (g = 0), Math.abs(h) < .001 && (h = 0), Math.abs(f) < .001 && (f = 0), Math.abs(u) < .001 && (u = 0), Math.abs(m) < .001 && (m = 0);
                            var v = "translate3d(" + g + "px," + h + "px," + f + "px)  rotateX(" + m + "deg) rotateY(" + u + "deg)";
                            if (l.transform(v), l[0].style.zIndex = -Math.abs(Math.round(c)) + 1, b.params.coverflow.slideShadows) {
                                var w = r() ? l.find(".swiper-slide-shadow-left") : l.find(".swiper-slide-shadow-top"),
                                    C = r() ? l.find(".swiper-slide-shadow-right") : l.find(".swiper-slide-shadow-bottom");
                ...
                initialImageLoaded: !1, loadImageInSlide: function (e, t) {
                    if ("undefined" != typeof e && ("undefined" == typeof t && (t = !0), 0 !== b.slides.length)) {
                        ...
                        !n.hasClass("swiper-lazy") || n.hasClass("swiper-lazy-loaded") || n.hasClass("swiper-lazy-loading") || (r = r.add(n[0])), 0 !== r.length && r.each(function () {
                            ...
                            var r = e.attr("data-background"), i = e.attr("data-src"), s = e.attr("data-srcset");
                            b.loadImage(e[0], i || r, s, !1, function () {
                                if (r ? (e.css("background-image", "url(" + r + ")"), e.removeAttr("data-background")) : (s && (e.attr("srcset", s), e.removeAttr("data-srcset")), i && (e.attr("src", i), e.removeAttr("data-src"))), e.addClass("swiper-lazy-loaded").removeClass("swiper-lazy-loading"), n.find(".swiper-lazy-preloader, .preloader").remove(), b.params.loop && t) {
                ...
                isTouched: !1, setDragPosition: function (e) {
                    var a = b.scrollbar,
                        ...
                        n = t - a.track.offset()[r() ? "left" : "top"] - a.dragSize / 2,
                        i = -b.minTranslate() * a.moveDivider, s = -b.maxTranslate() * a.moveDivider;
                    i > n ? n = i : n > s && (n = s), n = -n / a.moveDivider, b.updateProgress(n), b.setWrapperTranslate(n, !0)
                    ...
                    if (b.params.scrollbar) {
                        var e = b.scrollbar;
                        e.track = a(b.params.scrollbar), e.drag = e.track.find(".swiper-scrollbar-drag"), 0 === e.drag.length && (e.drag = a('<div class="swiper-scrollbar-drag"></div>'), e.track.append(e.drag)), e.drag[0].style.width = "", e.drag[0].style.height = "", e.trackSize = r() ? e.track[0].offsetWidth : e.track[0].offsetHeight, e.divider = b.size / b.virtualSize, e.moveDivider = e.divider * (e.trackSize / b.size), e.dragSize = e.trackSize * e.divider, r() ? e.drag[0].style.width = e.dragSize + "px" : e.drag[0].style.height = e.dragSize + "px", e.divider >= 1 ? e.track[0].style.display = "none" : e.track[0].style.display = "", b.params.scrollbarHide && (e.track[0].style.opacity = 0)
                    }
                }, setTranslate: function () {
                    if (b.params.scrollbar) {
                        var e, a = b.scrollbar, t = (b.translate || 0, a.dragSize);
                        e = (a.trackSize - a.dragSize) * b.progress, b.rtl && r() ? (e = -e, e > 0 ? (t = a.dragSize - e, e = 0) : -e + a.dragSize > a.trackSize && (t = a.trackSize + e)) : 0 > e ? (t = a.dragSize + e, e = 0) : e + a.dragSize > a.trackSize && (t = a.trackSize - e), r() ? (b.support.transforms3d ? a.drag.transform("translate3d(" + e + "px, 0, 0)") : a.drag.transform("translateX(" + e + "px)"), a.drag[0].style.width = t + "px") : (b.support.transforms3d ? a.drag.transform("translate3d(0px, " + e + "px, 0)") : a.drag.transform("translateY(" + e + "px)"), a.drag[0].style.height = t + "px"), b.params.scrollbarHide && (clearTimeout(a.timeout), a.track[0].style.opacity = 1, a.timeout = setTimeout(function () {
                ...
                LinearSpline: function (e, a) {
                    ...
                    var n, r, i = b.params.control;
                    if (b.isArray(i)) for (var s = 0; s < i.length; s++) i[s] !== a && i[s] instanceof Swiper && t(i[s]); else i instanceof Swiper && a !== i && t(i)
                    ...
                    if (b.isArray(r)) for (n = 0; n < r.length; n++) r[n] !== a && r[n] instanceof Swiper && t(r[n]); else r instanceof Swiper && a !== r && t(r)
                }
            }, b.parallax = {
                setTranslate: function () {
            ...
            for (var z in b.plugins) {
                var A = b.plugins[z](b, b.params[z]);
                A && b._plugins.push(A)
            }
            return b.callPlugins = function (e) {
                ...
                return e = d(e), b.emitterEventListeners[e] || (b.emitterEventListeners[e] = []), b.emitterEventListeners[e].push(a), b
            }, b.off = function (e, a) {
                var t;
                if (e = d(e), "undefined" == typeof a) return b.emitterEventListeners[e] = [], b;
        ...
        device: function () {
            var e = navigator.userAgent, a = e.match(/(Android);?[\s\/]+([\d.]+)?/),
                t = e.match(/(iPad).*OS\s([\d_]+)/), n = e.match(/(iPod)(.*OS\s([\d_]+))?/),
